...
const JobApply = () => {
    ...
    return (
       ...
       <p className="flex-1 dark:text-gray-600">My job</p>
       <div className="flex flex-col justify-end gap-3 mt-6 sm:flex-row">
           
           <button className="px-6 py-2 btn btn-primary rounded-sm shadow-sm dark:bg-violet-600 dark:text-gray-50">Apply</button>
       </div>
   </div>
          </div>
       </div>
